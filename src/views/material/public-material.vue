<template>
  <div>
    ...
    <el-card>
      ...
      <el-select v-model="selectSon" placeholder="请选择" @change="changeSon($event)">
        <el-option
    ...
    <el-card style="margin-top:15px">
      ...
      <el-table :data="tableData" style="width: 100%;margin-top:25px">
        ...
        <el-table-column label="素材类别 " #default="{row}">{{ row.sort + '-' + row.sort1 }}</el-table-column>
...
import { getMaterial } from "../../api/mock/zjc";
export default {
  components: {
    breadCrumbs
  },
