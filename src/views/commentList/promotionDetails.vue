  ...
  <div class="promotion-details">
    ...
    <el-card class="box-card">
      <el-table :data="list" style="width: 100%" :border="false">
        <el-table-column prop="shop_id" label="店铺ID" width="350">
        </el-table-column>
        <el-table-column prop="shop_name" label="店铺名称" width="200">
        </el-table-column>
        <el-table-column prop="address" label="店铺地址" width="400">
        </el-table-column>
        <el-table-column prop="shop_tel" label="店铺联系电话" width="300">
        </el-table-column>
        <el-table-column prop="open_date" label="推广开店日期" width="300">
        </el-table-column>
        <el-table-column prop="earnings" label="推广收益" #default="{row}">
          {{ row.earnings + "元" }}
        </el-table-column>
      </el-table>
